...
(* by coordinator $c$, described in Fast Paxos, Section 2.2.1 (on        *)
(* page 5) and refined by CA2$'$ (Fast Paxos, Section 3.3,    *)
(* page 22).^'                                               *)
(***************************************************************************)
Phase1a(c, i) == 
  /\ amLeader[c]
...
(* described in Fast Paxos, Section 3.2,                           *)
(* page 20.  With this action, coordinator $c$    *)
...
(* $i$ by acceptor $a$, described in Fast Paxos, Section 2.2.1 on        *)
(* page 5.^'                                                   *)
(***************************************************************************)
Phase1b(i, a) ==
  /\ rnd[a] < i
...
(* Fast Paxos, Section 2.2.1 on page 5 and                 *)
(* Fast Paxos, Section 3.1 on page 17.^'              *)
(***************************************************************************)
Phase2b(i, a, v) ==
  /\ rnd[a] \leq i
  /\ vrnd[a] < i
...
(* (Fast Paxos, Section 2.1) are equivalent to the invariance of these   *)
(* state predicates.^'                                                       *)
(***************************************************************************)
...
(* learners, condition $LA(p,l,c,Q)$ described by Fast Paxos,                           *)
(* page 10 of Section 2.3.1 is      *)
